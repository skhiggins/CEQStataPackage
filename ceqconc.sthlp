...
{pstd}
Note that the default PPP conversion factors and default income cutoffs are related. See Poverty Lines options and Income group cut-offs options for a more detailed explanation.
...
deciles, groups, centiles, and bins once for each sheet.
