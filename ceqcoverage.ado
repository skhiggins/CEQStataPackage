...
** CHANGES
**     30-09-2020 Fixed the totals issue for direct beneficiaries
...
local recbroad= "" // It's crucial to initialize this local in each round of the loop- June 30th, 2020
local paybroad=""
}
}
}
